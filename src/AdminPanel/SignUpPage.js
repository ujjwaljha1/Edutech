...
const Signup = () => {
  ...
  //   try {
  //     const response = await axios.post(`${config.backendUrl}/api/auth/signup`, { name, username, email, password });
  ...
  const handleVerificationSuccess = () => {
    window.location.href = "/"; // Refresh and navigate to home page after successful OTP verification
  };
